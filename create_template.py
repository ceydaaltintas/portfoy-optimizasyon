...
SHEETS = {
    ...
    "Havuzda_Bekleme": {
        ...
        "note": "OPSİYONEL. Saatlik portföy bekleme verisi. Doldurulursa yoğun portföylerin talebi otomatik şişirilir. Tarih: YYYY-MM-DD, Saat: HH:MM, süreler saniye cinsinden.",
    },
}
